...
namespace Scenes.ConnectScene.Scripts.Connectors {
    public class TelegramConnectController : IConnectController {
        /* Flow:
        ...
        public TelegramConnectController(
        ...
        private void ApplyState(StateType state) {
            ...
            switch (state) {
                ...
                case StateType.CheckAcceptTerms:
                    ToCheckAcceptTerms();
                    break;
                case StateType.LoginTelegram:
                    ToLoginThirdParty(ThirdPartyLogin.Telegram);
                    break;
        ...
        private void ToCheckAcceptTerms() {
            ...
            ApplyState(StateType.LoginTelegram);
        }
