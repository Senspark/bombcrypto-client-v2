...
namespace Scenes.InventoryScene.Scripts {
    public class DialogItemSell : Dialog {
        
        public static UniTask<DialogItemSell> Create() {
            return ServiceLocator.Instance.Resolve<IPrefabLoaderManager>().Instantiate<DialogItemSell>();
        }
        ...
        public void OnSellButtonClicked() {
            ...
            UniTask.Void(async () => {
                try {
                    await _marketplace.SellItemMarket(_itemId, _price, _amount, (int)_itemData.InventoryItemType, (int)(_itemData.ExpirationAfter / 1000));
                    _analytics.MarketPlace_TrackProduct(_itemData.ItemName, _price, _amount,
