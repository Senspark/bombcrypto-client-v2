...
namespace Game.UI {
    public class BLInventoryMiscInformation : BaseBLItemInformation {
        [SerializeField]
        ...
        [SerializeField]
        private GameObject buttonGoToFuse;
        ...
        public override void UpdateItem(ItemData data, bool showButton = true) {
            ...
            UpdateDuration(data);
            SetGoToFuse(data.InventoryItemType == InventoryItemType.Altar &&
                        data.ItemId != (int)GachaChestProductId.Scrap &&
                        data.ItemId != (int)GachaChestProductId.PerfectCrystal);
            SetItemDesc(data.ItemId);
        ...
        private void SetGoToFuse(bool value) {
            if (buttonGoToFuse != null) {
                buttonGoToFuse.gameObject.SetActive(value);
            }
        }

        private async void SetItemDesc(int itemId) {
            if (itemDesc != null) {
