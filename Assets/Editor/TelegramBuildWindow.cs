...
namespace Editor {
    ...
    public class TonBuildWindow: EditorWindow {
        private string _buildName = "ton";
        ...
        [MenuItem("Build/Build for Ton")]
        public static void ShowWindowTon() {
            GetWindow<TonBuildWindow>("Ton Build Window");
        }
        ...
        private void OnGUI() {
            ...
            if (_forTestOnly) {
                ...
                if (GUILayout.Button("Before build")) {
                    ComboBuildTon.BeforeBuild(_useBrotli);
                }
                if (GUILayout.Button("After build")) {
                    ComboBuildTon.AfterBuild();
                }
            ...
            if (GUILayout.Button("Build", GUILayout.Height(50))) {
                ComboBuildTon.BuildGame(_buildName, _useBrotli, _developerMode, _autoConnectProfiler, _deepProfiling,
                    _textureCompression, _powerPreference,
                    _maximumMemorySize, _exceptionSupport);
            }
        }

        public class ComboBuildTon {
            ...
            //Danh sách các atlas cần phải compress khi build TON (Compress Normal Quality)
            private static readonly List<string> SpriteAtlasNames = new List<string> {
            };

            //Danh sách chứa các atlas ko cần build cho bản TON
            ...
            private static readonly List<string> FoldersToMove = new List<string> {
                ...
                // "Assets/Textures/Resources/Avatar",
                // "Assets/Textures/Resources/BombIdle",
                // "Assets/Textures/Resources/Emoji",
                // "Assets/Textures/Resources/Enemies",
                // "Assets/Textures/Resources/Explosion",
                // "Assets/Textures/Resources/Items",
                // "Assets/Textures/Resources/SkinChest",
            };
            ...
            // Các thư mục resource ko cần cho bản build TOn liệt kê dứoi đây để bỏ qua khi build
            ...
            // Các addressable ko dùng cho TON sẽ đc disable trước khi build
            private static readonly List<string> AddressableGroupNames = new() {
                //"Default Local Group", "ScriptableAsset", "Shared", "TreasureScene"
            };

            private static readonly List<AddressableAssetGroup> AddressableGroupsToRevert = new();
            ...
            public static void BuildGame(string buildName, bool useBrotli, bool developerMode, bool autoConnectProfiler,
                ...
                if (!AppConfig.IsTon()) {
                    EditorUtility.DisplayDialog("Build Error",
                        "This build is only for Telegram builds.\nGo to AppConfig.json change isTelegram -> true",
                        "OK");
                    return;
                }
                ...
                try {
                    ...
                    Debug.LogError($"Lỗi khi build Telegram: {e.Message}");
            ...
            private static void DisableAddressableGroupsIncludeInBuild() {
                // return;
                // var settings = AddressableAssetSettingsDefaultObject.Settings;
                // if (settings == null) return;
                //
                // foreach (var group in settings.groups) {
                //     if (AddressableGroupNames.Contains(group.Name)) {
                //         var schema = group.GetSchema<BundledAssetGroupSchema>();
                //         if (schema != null) {
                //             AddressableGroupsToRevert.Add(group);
            ...
            private static void RevertAddressableGroupsIncludeInBuild() {
                // return;
                // foreach (var group in AddressableGroupsToRevert) {
                //     var schema = group.GetSchema<BundledAssetGroupSchema>();
                //     if (schema != null) {
