...
namespace Game.UI {
    public class BLAltarFuseList : MonoBehaviour {
        [SerializeField]
        private Transform container;

        [SerializeField]
        private BLAltarFuseItem itemPrefab;
        ...
        private readonly Dictionary<int, BLAltarFuseItem> _dictItems = new Dictionary<int, BLAltarFuseItem>();
        ...
        public void LoadData(List<IUiCrystalData> list) {
            _dictItems.Clear();
            ...
            for (var i = 0; i < num; i++) {
                ...
                var crystal = list[i];
                item.SetInfo(i, crystal, OnItemClicked);
                _dictItems[i] = item;
            }
