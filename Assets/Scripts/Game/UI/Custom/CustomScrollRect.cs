...
namespace Game.UI.Custom
{
    public class CustomScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        private int m_ScrollingCount = 0;
        public bool IsDragging => m_Dragging;
        public bool IsScrolling => m_ScrollingCount > 0;
        ...
        public virtual void OnScroll(PointerEventData data)
        {
            ...
            if (data.IsScrolling()) {
                m_Scrolling = true;
                m_ScrollingCount = 60; // check scroll 60 frame = 1s
            }
        ...
        protected virtual void SetNormalizedPosition(float value, int axis)
        {
            ...
            var hiddenLength = m_ContentBounds.size[axis] - m_ViewBounds.size[axis];
            // Where the position of the lower left corner of the content bounds should be, in the space of the view.
            var contentBoundsMinPosition = m_ViewBounds.min[axis] - value * hiddenLength;
            // The new content localPosition, in the space of the view.
            var newAnchoredPosition = m_Content.anchoredPosition[axis] + contentBoundsMinPosition - m_ContentBounds.min[axis];
