...
namespace App {
    [Service(nameof(IBHeroManager))]
    public interface IBHeroManager : IService {
        ...
        /// overwrites the existing entry without touching other heroes or the
        /// total-heroes counter on update.
        /// </summary>
        void ReplaceOneHero(IHeroDetails detail);
