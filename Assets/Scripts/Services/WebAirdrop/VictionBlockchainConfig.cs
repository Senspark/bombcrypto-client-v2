...
namespace App {
    public class VictionBlockchainConfig : IBlockchainConfig {
        public UniTask LoadAbi() {
            return UniTask.CompletedTask;
        }

        public string Chain => NetworkTypeInServer.VIC.ToString();
        ...
        public VictionBlockchainConfig(bool production) {
