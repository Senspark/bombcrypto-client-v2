...
namespace App {
    public class SolanaBlockchainConfig : IBlockchainConfig {
        public UniTask LoadAbi() {
            return UniTask.CompletedTask;
        }

        public string Chain => NetworkTypeInServer.SOL.ToString();
        ...
        public SolanaBlockchainConfig(bool production) {
