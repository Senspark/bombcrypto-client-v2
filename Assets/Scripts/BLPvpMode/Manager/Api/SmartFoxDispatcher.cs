...
namespace BLPvpMode.Manager.Api {
    public class SmartFoxDispatcher: ISmartFoxDispatcher {
        
        [NotNull]
        private readonly DispatchEventDelegate _dispatchEvent;

        public SmartFoxDispatcher(DispatchEventDelegate dispatchEvent) {
        ...
        public void OnExtensionResponse(BaseEvent evt) {
            ...
            _dispatchEvent(listener => listener.OnExtensionResponse(cmd, value));
        }
    }
}