...
public class JoystickEditor : Editor
{
    ...
    protected SerializedProperty down;
    protected SerializedProperty up;
    protected SerializedProperty left;
    protected SerializedProperty right;
    protected SerializedProperty blinkButton;
    ...
    protected virtual void OnEnable()
    {
        ...
        blinkButton = serializedObject.FindProperty("blinkButton");
    }
    ...
    protected virtual void DrawJoypadButton()
    {
        EditorGUILayout.ObjectField(down, new GUIContent("down", ""));
        EditorGUILayout.ObjectField(up, new GUIContent("up", ""));
        EditorGUILayout.ObjectField(left, new GUIContent("left", ""));
        EditorGUILayout.ObjectField(right, new GUIContent("right", ""));
        EditorGUILayout.ObjectField(blinkButton, new GUIContent("blinkButton", ""));
    }
}