...
namespace CreativeSpore.SuperTilemapEditor {
    ...
    public class STETilemap : MonoBehaviour {
        ...
        /// </summary>
        private int k_chunkSize = 64;

        public int ChunkSize {
            set { k_chunkSize = value; }
        }
        ...
        public TilemapChunk GetTileChunk(int gridX, int gridY) {
        ...
        private TilemapChunk GetOrCreateTileChunk(int gridX, int gridY, bool createIfDoesntExist = false) {
            ...
            if (tilemapChunk == null && createIfDoesntExist) {
                ...
                tilemapChunk =
                    chunkObj
                        .AddComponent<
                            TilemapChunk>(); //NOTE: this call TilemapChunk.OnEnable before initializing the TilemapChunk. Make all changes after this.
