...
import {SupportedNetwork} from "../controllers/RpcNetworkUtils.ts";
...
const ConnectNetwork = (props: IProps) => {
    ...
    const handleNetwork = (network: SupportedNetwork) => {
        authService.setAccountNetwork(network);
    ...
    const modal = (
        <FullScreenWrapper open={props.open}>
            <NetworkBoardWrapper onClick={handleContentClick}>
                ...
                <MiddleBar>
                    <StyledNetwork onClick={() => handleNetwork("bsc")}>
