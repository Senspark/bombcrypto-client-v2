...
namespace Senspark.Internal {
    internal class AdMobRewardedInterstitialAdBridge : IFullScreenAdBridge {
        [NotNull]
        ...
        public AdMobRewardedInterstitialAdBridge(
            [NotNull] string id,
        ...
        public async Task<(bool, string)> Load() {
            _ad?.Destroy();
            _ad = null;
            var tcs = new TaskCompletionSource<(RewardedInterstitialAd, string)>();
            // ReSharper disable once VariableHidesOuterVariable
            RewardedInterstitialAd.Load(_id, new AdRequest(), (ad, error) => {
